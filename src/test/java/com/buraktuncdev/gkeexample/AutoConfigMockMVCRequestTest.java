...
public class AutoConfigMockMVCRequestTest {
	 ...
	 * That way, almost of the full stack is used, and your code will be called in
	 * exactly the same way as if it were processing a real HTTP request but without the cost of starting the server.
	...
	*/
	...
	public void shouldReturnDefaultMessage() throws Exception{
		this.mockMvc.perform(get("/"))
				...
				.andExpect(content().string(containsString("Hello, Burak")));
	}
